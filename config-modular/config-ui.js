// ========== CONFIG-UI.JS ==========
// Interface do modal de configurações (660 linhas)
(function() {
    'use strict';
    ...
    function showConfigModal() {
        ...
        currentConfig = window.TWS_ConfigModal.Core.getConfig();
            ...
            <div class="tws-config-content-wrapper">
                ...
                <div id="tab-unidades" class="tws-config-tab-content active">
                    <div class="tws-config-section">
                        ...
                        <div class="tws-config-grid" id="unit-speed-config">
                            ${Object.entries(currentConfig.velocidadesUnidades).map(([unit, speed]) => `
                                <div class="tws-config-item">
                                    <div class="tws-config-label">${window.TWS_ConfigModal.Core.getUnitDisplayName(unit)}</div>
                    ...
                    <div class="tws-config-section">
                        ...
                        <div class="tws-form-group">
                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="telegram-enabled" ${currentConfig.telegram.enabled ? 'checked' : ''}>
                        ...
                        <div class="tws-form-group">
                            ...
                            <input type="password" class="tws-form-input" 
                                   id="telegram-token" value="${currentConfig.telegram.botToken}" placeholder="123456789:ABCdefGHIjkl..." />
                        ...
                        <div class="tws-form-group">
                            ...
                            <input type="text" class="tws-form-input" 
                                   id="telegram-chatid" value="${currentConfig.telegram.chatId}" placeholder="-100123456789" />
                            <small style="color: #718096; font-size: 12px;">
                        ...
                        <div class="tws-form-group">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                                <div class="tws-checkbox-group">
                                    <input type="checkbox" id="telegram-notif-success" ${currentConfig.telegram.notifications.success ? 'checked' : ''}>
                                    <label for="telegram-notif-success">✅ Ataques bem-sucedidos</label>
                                </div>
                                <div class="tws-checkbox-group">
                                    <input type="checkbox" id="telegram-notif-failure" ${currentConfig.telegram.notifications.failure ? 'checked' : ''}>
                                    <label for="telegram-notif-failure">❌ Ataques falhos</label>
                                </div>
                                <div class="tws-checkbox-group">
                                    <input type="checkbox" id="telegram-notif-farm" ${currentConfig.telegram.notifications.farmCycle ? 'checked' : ''}>
                                    <label for="telegram-notif-farm">🔄 Ciclos de Farm</label>
                                </div>
                                <div class="tws-checkbox-group">
                                    <input type="checkbox" id="telegram-notif-error" ${currentConfig.telegram.notifications.error ? 'checked' : ''}>
                    ...
                    <div class="tws-config-section">
                        ...
                        <div class="tws-form-group">
                            ...
                            <select class="tws-form-input" id="theme-select">
                                <option value="light" ${currentConfig.theme === 'light' ? 'selected' : ''}>🌞 Claro</option>
                                <option value="dark" ${currentConfig.theme === 'dark' ? 'selected' : ''}>🌙 Escuro</option>
                                <option value="auto" ${currentConfig.theme === 'auto' ? 'selected' : ''}>⚡ Automático (Sistema)</option>
                            </select>
                        </div>
                        ...
                        <div class="tws-form-group">
                            <label class="tws-form-label">Notificações:</label>
                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="show-notifications" ${currentConfig.behavior.showNotifications ? 'checked' : ''}>
                                <label for="show-notifications">Mostrar notificações na tela</label>
                            </div>
                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="sound-on-complete" ${currentConfig.behavior.soundOnComplete ? 'checked' : ''}>
                ...
                <div id="tab-comportamento" class="tws-config-tab-content">
                    <div class="tws-config-section">
                        ...
                        <div class="tws-form-group">
                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="auto-start-scheduler" ${currentConfig.behavior.autoStartScheduler ? 'checked' : ''}>
                                <label for="auto-start-scheduler">Iniciar scheduler automaticamente</label>
                            </div>
                            
                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="retry-on-fail" ${currentConfig.behavior.retryOnFail ? 'checked' : ''}>
                                <label for="retry-on-fail">Tentar novamente em caso de falha</label>
                            </div>

                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="confirm-deletion" ${currentConfig.behavior.confirmDeletion ? 'checked' : ''}>
                                <label for="confirm-deletion">Confirmar antes de excluir</label>
                            </div>

                            <div class="tws-checkbox-group">
                                <input type="checkbox" id="ask-before-send" ${currentConfig.behavior.askBeforeSend ? 'checked' : ''}>
                        ...
                        <div class="tws-form-group">
                            ...
                            <input type="number" class="tws-form-input" 
                                   id="max-retries" value="${currentConfig.behavior.maxRetries}" min="1" max="10" style="width: 120px;" />
                        </div>
                        ...
                        <div class="tws-form-group">
                            ...
                            <select class="tws-form-input" id="scheduler-check-interval" style="width: 200px;">
                                <option value="50" ${currentConfig.behavior.schedulerCheckInterval === 50 || !currentConfig.behavior.schedulerCheckInterval ? 'selected' : ''}>⚡ 50ms - Padrão (Máxima Precisão)</option>
                                <option value="100" ${currentConfig.behavior.schedulerCheckInterval === 100 ? 'selected' : ''}>⚡ 100ms - Alta Precisão</option>
                                <option value="250" ${currentConfig.behavior.schedulerCheckInterval === 250 ? 'selected' : ''}>⭐ 250ms - Rápido</option>
                                <option value="500" ${currentConfig.behavior.schedulerCheckInterval === 500 ? 'selected' : ''}>⭐ 500ms - Balanceado</option>
                                <option value="1000" ${currentConfig.behavior.schedulerCheckInterval === 1000 ? 'selected' : ''}>⭐ 1000ms - Moderado</option>
                                <option value="2000" ${currentConfig.behavior.schedulerCheckInterval === 2000 ? 'selected' : ''}>🔋 2000ms - Econômico</option>
                                <option value="5000" ${currentConfig.behavior.schedulerCheckInterval === 5000 ? 'selected' : ''}>🔋 5000ms - Muito Econômico</option>
                                <option value="custom">🎛️ Personalizado</option>
                            </select>
                            
                            <!-- Campo personalizado (inicialmente oculto) -->
                            <input type="number" class="tws-form-input" id="scheduler-check-interval-custom" 
                                   value="${currentConfig.behavior.schedulerCheckInterval}" min="50" max="30000" step="50" 
                            ...
                            <div id="interval-precision" style="margin-top: 8px; font-size: 12px; padding: 5px; border-radius: 4px; background: #E6FFFA; color: #234E52;">
                                🎯 Precisão atual: ±${window.TWS_ConfigModal.Core.calculatePrecision(currentConfig.behavior.schedulerCheckInterval || 1000)}ms
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tws-config-section">
                        ...
                        <div style="background: #EDF2F7; padding: 15px; border-radius: 6px;">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px; font-size: 13px;">
                                ...
                                <div>Configurações: <span id="stats-config-size">${Math.round(JSON.stringify(currentConfig).length / 1024 * 100) / 100}</span> KB</div>
                                <div>Telegram: <span id="stats-telegram">${currentConfig.telegram.enabled ? '✅ Ativo' : '❌ Inativo'}</span></div>
                            </div>
                        </div>
        ...
        setTimeout(() => {
            if (window.TWS_ConfigModal.Telegram) {
                window.TWS_ConfigModal.Telegram.populateModal();
            }
            updateTelegramStats();
        }, 100);
    ...
    function updateIntervalPrecision() {
        ...
        const precision = window.TWS_ConfigModal.Core.calculatePrecision(intervalValue);
        const color = window.TWS_ConfigModal.Core.getPrecisionColor(intervalValue);
        
        precisionEl.innerHTML = `🎯 Precisão atual: ±${precision}ms`;
        precisionEl.style.background = color;
    }

    // === HANDLERS DAS ABAS ===
    function resetUnitSpeeds() {
        if (confirm('Resetar velocidades para valores padrão?')) {
            const config = window.TWS_ConfigModal.Core.getConfig();
            config.velocidadesUnidades = { ...window.TWS_ConfigModal.Core.defaultConfig.velocidadesUnidades };
            window.TWS_ConfigModal.Core.saveConfig(config);
    ...
    async function testTelegram() {
        ...
        try {
            ...
            if (window.TWS_ConfigModal.Telegram) {
                window.TWS_ConfigModal.Telegram.updateFromModal();
                const result = await window.TWS_ConfigModal.Telegram.testConnection();
                ...
                showTelegramStatus('❌ Módulo Telegram não carregado', 'error');
            }
        } catch (error) {
    ...
    async function sendTestMessage() {
        ...
        try {
            ...
            if (window.TWS_ConfigModal.Telegram) {
                window.TWS_ConfigModal.Telegram.updateFromModal();
                const result = await window.TWS_ConfigModal.Telegram.sendTestMessage();
            ...
            reader.onload = (event) => {
                try {
                    ...
                    if (confirm('Importar estas configurações? Isso substituirá suas configurações atuais.')) {
                        window.TWS_ConfigModal.Core.saveConfig(importedConfig);
    ...
    function backupData() {
        const backup = {
            config: window.TWS_ConfigModal.Core.getConfig(),
    ...
    function resetConfig() {
        if (confirm('⚠️ TEM CERTEZA?\n\nIsso resetará TODAS as configurações para os valores padrão.')) {
            localStorage.removeItem(window.TWS_ConfigModal.Core.CONFIG_STORAGE_KEY);
            window.TWS_ConfigModal.Core.applyConfig(window.TWS_ConfigModal.Core.defaultConfig);
    ...
    function saveConfigHandler() {
        ...
        document.querySelectorAll('.tws-config-input').forEach(input => {
            const unit = input.dataset.unit;
            const value = parseFloat(input.value) || window.TWS_ConfigModal.Core.defaultConfig.velocidadesUnidades[unit];
        ...
        if (window.TWS_ConfigModal.Telegram) {
            window.TWS_ConfigModal.Telegram.updateFromModal();
            Object.assign(config.telegram, window.TWS_ConfigModal.Telegram.getConfig());
        }
        ...
        if (intervalSelect.value === 'custom') {
            schedulerInterval = parseInt(customInput.value) || 50;
        } else {
            schedulerInterval = parseInt(intervalSelect.value) || 50;
        }
        
        config.behavior.schedulerCheckInterval = Math.max(50, Math.min(30000, schedulerInterval));
        
        if (window.TWS_ConfigModal.Core.saveConfig(config)) {
    ...
    // === FUNÇÕES DO TELEGRAM ===
    function viewTelegramHistory() {
        if (!window.TWS_ConfigModal.Telegram) {
            showStatus('❌ Módulo Telegram não carregado', 'error');
            return;
        }
        
        const history = window.TWS_ConfigModal.Telegram.getHistory();
        const stats = window.TWS_ConfigModal.Telegram.getStats();
    ...
    function clearTelegramHistory() {
        if (confirm('Limpar todo o histórico do Telegram?')) {
            if (window.TWS_ConfigModal.Telegram && window.TWS_ConfigModal.Telegram.clearHistory()) {
    ...
    function updateTelegramStats() {
        if (!window.TWS_ConfigModal.Telegram) return;
    ...
    function setupEventListeners() {
        ...
        document.getElementById('telegram-enabled')?.addEventListener('change', () => {
            if (window.TWS_ConfigModal.Telegram) {
                window.TWS_ConfigModal.Telegram.updateUIState();
            }
        });
    }
    ...
    window.resetUnitSpeeds = resetUnitSpeeds;
    window.testUnitSpeed = testUnitSpeed;
    ...
    window.saveConfig = saveConfigHandler;
    window.saveAndCloseConfig = function() {
        saveConfigHandler();
        closeConfigModal();
    };
    window.closeConfigModal = closeConfigModal;
    window.viewTelegramHistory = viewTelegramHistory;
    window.clearTelegramHistory = clearTelegramHistory;
    ...
    // === INICIALIZAÇÃO ===
    function initUI() {
        console.log('[Config UI] ✅ Interface carregada');
    }
