...
`.trim();
  ...
  function Antibot() { if (window.TWS_AntiBotModal) window.TWS_AntiBotModal.show(); }
    ...
    panel.innerHTML = `
      <div style="margin-bottom:15px;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px;">
          ...
          <button onclick="TWS_Panel.AntiBotModal()" style="padding:6px 12px;background:#9C27B0;color:white;border:none;border-radius:4px;cursor:pointer;">🛡️ Proteção</button>
          </div>
      </div>
  ...
  setTimeout(()=>{
    ...
    if(!window.TWS_AntiBotModal) console.warn('[TW Scheduler] ⚠️ Modal de AntiBot não detectado.');
