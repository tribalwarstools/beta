  ...
  function createUI() {
    ...
    panel.innerHTML = `
      <div style="margin-bottom:15px;">
        ...
        // Dentro da função createUI(), adicione este botão:
          <button onclick="window.TWS_AntiBotModal.show()" style="padding:6px 12px;background:#9C27B0;color:white;border:none;border-radius:4px;cursor:pointer;">🛡️ Proteção</button>        </div>
      </div>
